...
Form::Form(const Form &other) : _name(other._name), _sign(other._sign), _exec_grade(other._exec_grade), _sign_grade(other._sign_grade)
{
  ...
  //  this->_sign_grade = other.getSign_Grade();
    //this->_exec_grade = other.getExec_Grade();
}
